...
_compare:
	...
	mov	al, byte[rsi + rcx]	; move the character of s2 in al
	cmp	dl, 0				; check if s1 is at terminating character
	je	_return				; if s1 is at terminating character, return
...
_return:
	...
	mov	rax, rdx			; move value of rdx in rax
	ret						; return rax
